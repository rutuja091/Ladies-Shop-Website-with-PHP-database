...
High quality T-shirts start with 100% high quality, pre-shrunk cotton. 
    ...
    <a href="./user_area/user_registration.php" class="btn btn-info">View More</a>
...
?>
   ...
   <li class="nav-item" >
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>Adidas</h6>
  </a>
   </li>
   <li class="nav-item" >
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>Bentex</h6>
  </a>
   </li>
   
   <li class="nav-item ">
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>Paragon</h6>
  </a>
   </li>
   <li class="nav-item ">
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>Lakme</h6>
  </a>
   </li>
   <li class="nav-item ">
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>Titan</h6>
  </a>
   </li>
</ul>
...
<li class="nav-item ">
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>T-Shirt</h6>
  </a>
   </li>
   <li class="nav-item ">
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>Lehanga</h6>
  </a>
   </li>
   <li class="nav-item ">
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>Jewellery</h6>
  </a>
   </li>
   <li class="nav-item ">
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>Sandal</h6>
  </a>
   </li>
   <li class="nav-item ">
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>Beauty Product</h6>
  </a>
   </li>
   <li class="nav-item ">
    <a href="./user_area/user_registration.php" class="nav-link text-light " ><h6>Watch</h6>
  </a>
   </li>
