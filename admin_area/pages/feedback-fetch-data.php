        ...
        <div class="row mt-5 mb-5">
            <div class="col">
                ...
                <div class="card-header">
                     <h2 class="display-6 text-center head-name"> Manage User Feedback </h2>
                          <div class="header-btn">
                    
                     <a href="..\pages\report_user_feedback.php"><button class="btn1 bg-info">View Report</button></a>
                    </div>
                    </div>
                        ...
                        <table class="table table-bordered text-center">
                          <tr >
                           ...
                           <!-- <td class="bg-secondary  text-white"> Confirm Password</td>-->
                            <td class="bg-secondary  text-white">Message</td>
...
echo "<td ><a href=\"delete-feedback-fetch.php?id=$res[id]\" onClick=\"return confirm('Are you sure ,you want to delete?')\">Delete</a></td>";
