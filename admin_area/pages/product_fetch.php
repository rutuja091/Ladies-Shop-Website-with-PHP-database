            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                     <h2 class="display-6 text-center head-name"> Manage Product </h2>
                          <div class="header-btn">
                     <a href="..\add-product.php"><button class="btn1 bg-info">Add Product</button></a>
                     <a href="..\pages\report-product.php"><button class="btn1 bg-info">View Report</button></a>
                    </div>
                    </div>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                          <tr  >
                          <th class="bg-secondary  text-white p-2 ">Sr. no</th>
                             <th class="bg-secondary text-white p-2">Product img</th>
                             <th class="bg-secondary  text-white p-2">Product name</th>
                             <th class="bg-secondary  text-white p-2">Product description</th>
                             <th class="bg-secondary  text-white p-2">Product price</th>
                             <th class="bg-secondary  text-white p-2">Product Category</th>
                          
                            <th class="bg-success  text-white ">Edit</a></th>
                            <th class="bg-danger  text-white">Delete</a></th>
                          </tr>
...
while($row=mysqli_fetch_array($query_run)){
 ...
 <?php echo" <td >".++$i."</td>";?>
     ...
     <?php
      ...
      echo "<td ><a href=\"delete_product.php?id=$row[id]\" onClick=\"return confirm('Are you sure ,you want to delete?')\">Delete</a></td>";
