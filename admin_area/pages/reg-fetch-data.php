        ...
        <div class="row mt-5 mb-5">
            <div class="col">
                ...
                <div class="card-header">
                     <h2 class="display-6 text-center head-name"> Manage User Registration </h2>
                          <div class="header-btn">
                    
                     <a href="..\pages\report_user_register.php"><button class="btn1 bg-info">View Report</button></a>
                    </div>
                    </div>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                          <tr >
                            ...
                            <td class="bg-secondary  text-white">Password</td>
                           <!-- <td class="bg-secondary  text-white"> Confirm Password</td>-->
                            <td class="bg-secondary  text-white">Address</td>
                            <td class="bg-secondary  text-white">Contact</td>
                            <td class="bg-success  text-white">Edit</a></td>
...
while ($res = $query->fetch_assoc())
 {
  ...
  echo "<td>".$res['user_address']."</td>";
  echo "<td>".$res[	'user_contact']."</td>";
  echo "<td><a href=\"edit_reg.php?id=$res[id]\">Edit</a></td>";

echo "<td ><a href=\"delete-reg-fetch.php?id=$res[id]\" onClick=\"return confirm('Are you sure ,you want to delete?')\">Delete</a></td>";
