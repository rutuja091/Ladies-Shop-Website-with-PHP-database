...
<div class="col-md-4 mb-2"> 
  ...
  <img src="..\images\view_product\jewellery\necklace_1.jpeg" class="card_img" alt="...">
  
  <div class="card-body" id="card_body">
   <h5 class="card-title">Necklace</h5>
    <p class="card-text">Gold polish bentex necklaces Haar set Jewellery set Gold polish bentex necklaces Micro polish haar set.</p>
    <a href="..\buy_now\buy_jewellery_1.php" class="btn btn-info" id="button">Buy Now</a>
...
<div class="col-md-4 mb-2">
  ...
  <img src="..\images\view_product\jewellery\bengals_2.jpg"class="card_img" alt="...">
 
  <div class="card-body" id="card_body">
    <h5 class="card-title">Bengals</h5>
    <p class="card-text">Base Metal: Bentex Plating: Gold Plated Stone Type: No Stone Sizing: Non-Adjustable Type: Bangle Set .</p>
    <a href="..\buy_now\buy_jewellery_2.php" class="btn btn-info" id="button">Buy Now</a>
...
<div class="col-md-4 mb-2"> 
  ...
  <img src="..\images\view_product\jewellery\ring_3.jpg" class="card_img" alt="...">
 
  <div class="card-body" id="card_body">
    <h5 class="card-title">Ring</h5>
    <p class="card-text">	
Base Metal: Bentex Plating: Alexandrite  
Traditional Bentex Plated yearing for girls Women</p>

<a href="..\buy_now\buy_jewellery_3.php" class="btn btn-info" id="button">Buy Now</a>
  </div>
</div></div>
...
$sql = "SELECT * FROM add_product WHERE product_category='Jewellary' ORDER BY id DESC ";
